...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-chainmart-dev-key-change-in-production')
...
LOGGING = {
    ...
    'handlers': {
        ...
        'file': {
            ...
            'filename': BASE_DIR / 'logs' / 'chainmart.log',
            'formatter': 'verbose',
        },
    },
    'loggers': {
...
BLOCKCHAIN_CONFIG = {
    'NETWORK': os.environ.get('BLOCKCHAIN_NETWORK', 'amoy'),  # amoy for testnet, polygon for mainnet
    ...
    'REPUTATION_NFT_CONTRACT': os.environ.get('REPUTATION_NFT_ADDRESS'),
...
DEFAULT_FROM_EMAIL = os.environ.get('DEFAULT_FROM_EMAIL', 'noreply@chainmart.com')
